...
public class PlanetFigure extends EllipseFigure
{
    ...
    public Vector<Handle> handles()
    {
        ...
        handles.add(new PlanetHandle(this, RelativeLocator.southWest(), 0, 120));
        handles.add(new PlanetHandle(this, RelativeLocator.southEast(), 0, 120));
        handles.add(new PlanetHandle(this, RelativeLocator.northWest(), 0, 120));
